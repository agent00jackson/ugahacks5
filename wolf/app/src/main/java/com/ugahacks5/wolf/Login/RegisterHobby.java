...
import com.ugahacks5.wolf.Main.MainActivity;
...
public class RegisterHobby extends AppCompatActivity {
    ...
    public void sportsButtonClicked() {
        ...
        if (sportsSelectionButton.getAlpha() == 1.0f) {
            ...
            sportsSelectionButton.setBackgroundColor(Color.parseColor("#12B8FF"));
    ...
    public void travelButtonClicked() {
        ...
        if (travelSelectionButton.getAlpha() == 1.0f) {
            ...
            travelSelectionButton.setBackgroundColor(Color.parseColor("#12B8FF"));
    ...
    public void musicButtonClicked() {
        ...
        if (musicSelectionButton.getAlpha() == 1.0f) {
            ...
            musicSelectionButton.setBackgroundColor(Color.parseColor("#12B8FF"));
    ...
    public void fishingButtonClicked() {
        ...
        if (fishingSelectionButton.getAlpha() == 1.0f) {
            ...
            fishingSelectionButton.setBackgroundColor(Color.parseColor("#12B8FF"));
